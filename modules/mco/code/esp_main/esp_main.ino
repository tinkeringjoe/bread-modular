...
// const int pinOsc1 = 40;
// const int pinGate1 = 39;
...
//   pinMode(pinOsc1, OUTPUT);
//   digitalWrite(pinOsc1, LOW);

//   pinMode(pinGate1, OUTPUT);
//   digitalWrite(pinGate1, LOW);
